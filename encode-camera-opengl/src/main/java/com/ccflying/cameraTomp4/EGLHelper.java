...
/**
 * 持有MediaCodec encoder输入源的Surface的状态。
 * <p>
 * 在构造方法中，传入MediaCodec#createInputSurface()获取到的输入源的Surface，
 * 接着使用它来创建一个EGL window surface，
 * 调用eglSwapBuffers()，将使frame data被发送到 MediaCodec encoder。
 * <p>
 */
public class EGLHelper {
    ...
    private void eglSetup() {
        ...
        // 使用MediaCodec的输入源Surface，创建一个EGLSurface。
