...
import com.ccf.encode_decode.encode.fbocamera.util.DisplayUtil;
...
public class CameraFboRender implements GLSurfaceView.Renderer {
    ...
    private OnSurfaceTextureCreatedCallback mSurfaceListener;
    ...
    public GLSurfaceView.Renderer getCameraRenderer() {
        return cameraRender;
    }
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        cameraRender = new CameraRender(context, fboTextureId);
        cameraRender.onSurfaceCreated(null, null);
    }
    ...
    public void onSurfaceChanged(GL10 gl, int width, int height) {
        ...
        cameraRender.onSurfaceChanged(null, width, height);
    }
    ...
    private void createCameraRenderTexture() {
        ...
        if (mSurfaceListener != null) {
            mSurfaceListener.onSurfaceCreated(surfaceTexture, fboTextureId);
        }
    ...
    public void setOnSurfaceCreatedCallback(OnSurfaceTextureCreatedCallback onSurfaceListener) {
        this.mSurfaceListener = onSurfaceListener;
    }

    public interface OnSurfaceTextureCreatedCallback {
        void onSurfaceCreated(SurfaceTexture surfaceTexture, int fboTextureId);
    }
